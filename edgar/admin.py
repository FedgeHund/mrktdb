...
from .models import Company, Filer, QuarterlyHolding, Security, QuarterlyOtherManagerDistribution, QuarterlySecurityHolding, QuarterlyOtherManager, CikCusipMapping
...
admin.site.register(CikCusipMapping)
