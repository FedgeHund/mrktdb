...
const ENV_VARIABLES = {
	ENVIRON: "prod",
	DEV_API_URL: "localhost:8000",
	PROD_API_URL: "ec2-3-138-110-167.us-east-2.compute.amazonaws.com",
	// PROD_API_URL: "mrktdb.eba-brufwk2z.us-west-2.elasticbeanstalk.com",
	// PROD_API_URL: "mrktdb.com",
};

let URL;
if (ENV_VARIABLES.ENVIRON == "dev") URL = ENV_VARIABLES.DEV_API_URL;
else URL = ENV_VARIABLES.PROD_API_URL;
