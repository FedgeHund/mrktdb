    ...
    return (
        <Fragment>
            ...
            <div className="faq_container">
                <div className="faq">
                    <div className="row">
                        <div className="offset-md-1 col-md-10 faq_heading">Frequently Asked Questions</div>
                    </div>

                    <div accordion_container>
                        <div class="offset-1 col-10 accordion accordion-flush" id="accordionFlushExample">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingOne">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="true" aria-controls="flush-collapseOne">
                                        ...
                                        <div className="minus">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-dash-circle" viewBox="0 0 16 16">
                                                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingFive">
                                    ...
                                    I found an error in one of your filings. Why is it so?
                                </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingSix">
                                    ...
                                    How up-to-date are the filings on MrktDB?
                                </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingSeven">
                                    ...
                                    What is 'Estimated Average Price Paid'? How is it determined?
                                </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingEight">
                                    ...
                                    What do the designations PNR, CALL, and PUT mean?
                                </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingNine">
                                    ...
                                    The quarter ended 2 weeks ago, why hasn't the Heat Map/ Index/ Stats page been updated yet?
                                </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingTen">
                                    ...
                                    How far back does the MrktDB database go?
                                </button>
                                </h2>
                    ...
                    <br />
                    <div className="row">
                        <a className="col-md-10 col-9 contact_us_link" href="/contactus">Couldn't find the answer to your questions? &nbsp;&nbsp; <i class="fas fa-hand-point-right"></i>&nbsp; Contact Us </a>
                    </div>
                </div>
            </div>
