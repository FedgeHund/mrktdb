...
function TopSellsTable(props) {
    ...
    if (typeof data !== 'undefined' && data.length > 0) {
        ...
        var topSellSymbol1 = data[0]["ticker"];
        var topSellSecurityName1 = data[0]["securityName"];
        var topSellSecurityType1 = data[0]["type1"];
        var topSellMarketValue1 = data[0]["marketValue"];
        var topSellchangePercent1 = data[0]["changeInPositionPercent"].toFixed(2) + " %";;

        var topSellSymbol2 = data[1]["ticker"];
        var topSellSecurityName2 = data[1]["securityName"];
        var topSellSecurityType2 = data[1]["type1"];
        var topSellMarketValue2 = data[1]["marketValue"];
        var topSellchangePercent2 = data[1]["changeInPositionPercent"].toFixed(2) + " %";;

        var topSellSymbol3 = data[2]["ticker"];
        var topSellSecurityName3 = data[2]["securityName"];
        var topSellSecurityType3 = data[2]["type1"];
        var topSellMarketValue3 = data[2]["marketValue"];
        var topSellchangePercent3 = data[2]["changeInPositionPercent"].toFixed(2) + " %";;

        var topSellSymbol4 = data[3]["ticker"];
        var topSellSecurityName4 = data[3]["securityName"];
        var topSellSecurityType4 = data[3]["type1"];
        var topSellMarketValue4 = data[3]["marketValue"];
        var topSellchangePercent4 = data[3]["changeInPositionPercent"].toFixed(2) + " %";;

        var topSellSymbol5 = data[4]["ticker"];
        var topSellSecurityName5 = data[4]["securityName"];
        var topSellSecurityType5 = data[4]["type1"];
        var topSellMarketValue5 = data[4]["marketValue"];
        var topSellchangePercent5 = data[4]["changeInPositionPercent"].toFixed(2) + " %";;
