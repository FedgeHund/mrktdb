    	...
    	<Fragment>
			...
			<div className="get_started_container">
	           	<div className="get_started_box shadow">
	           		...
	           		<div className="row">
	           			<div className="exclusive_insights_text col-10 col-sm-10 col-md-10 col-lg-7 col-xl-7">Exclusive insights into the portfolios of the smartest investors on the platform of your choice!</div>
	           		</div>

	           		<div className="row">
	           			<div className="sign_up_personalized col-md-10 col-xs-10 col-10">Sign Up for personalised, experienced and exclusive content</div>
	           		</div>
