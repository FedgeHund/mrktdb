  	...
  	return (
    	<Fragment>
			...
			<div className="what_is_13F_container">
           		...
           		<div className="what_is_13f_box">
	           		<div className="row">
		       			<div className="what_is_13f_text offset-1 col-5">What is 13F?</div>
		       			<div className="key_takeaways_head offset-1 offset-sm-1 offset-md-0 col-4">KEY <br/> TAKEAWAYS</div>
		       		</div>
		       		
		       		<div className="row mt-5">
		       			<div className="offset-1 col-5 col-sm-5 col-md-4 what_is_13f_content">
		       			...
		       			<div className="offset-1 col-5 col-sm-5 col-md-4 key_takeaways_content">
